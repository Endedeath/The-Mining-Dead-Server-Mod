...
import com.tmdmc.mod.entity.ai.AIBomber;
...
public class EntityBomber extends EntityMob
{
    ...
    public EntityBomber(World p_i1733_1_)
    {
        super(p_i1733_1_);
        ...
        this.tasks.addTask(2, new AIBomber(this));
    ...
    public void onDeath(DamageSource p_70645_1_)
    {
        ...
        this.worldObj.createExplosion(this, this.posX, this.posY, this.posZ, (float)this.explosionRadius + 4, false);
    }
