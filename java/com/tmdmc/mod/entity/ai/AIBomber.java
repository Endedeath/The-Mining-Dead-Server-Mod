package com.tmdmc.mod.entity.ai;

import com.tmdmc.mod.entity.EntityBomber;

import net.minecraft.entity.EntityLivingBase;
import net.minecraft.entity.ai.EntityAIBase;

public class AIBomber extends EntityAIBase
{
    /** The creeper that is swelling. */
    EntityBomber swellingCreeper;
    /** The creeper's attack target. This is used for the changing of the creeper's state. */
    EntityLivingBase creeperAttackTarget;
    private static final String __OBFID = "CL_00001614";

    public AIBomber(EntityBomber p_i1655_1_)
    {
